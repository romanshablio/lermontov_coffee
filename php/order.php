...
$mysql->query("INSERT INTO `users` (`Name`, `Phone`, `PromoCode`, `GoodnessRating`, `SpeedRating`, `ProductQuality`, `Сleanliness`, `date`, `Review`) VALUES('$Name', '$Phone', '$PromoCode', '$GoodnessRating', '$SpeedRating', '$ProductQuality', '$Сleanliness', '$date', '$Review')"); //создаю запрос на добавление данных в таблицу users значениями из полей.
